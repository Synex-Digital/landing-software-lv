...
<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            <li><a href="{{ route('welcome') }}" class="ai-icon" aria-expanded="false">
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10.115 14.3525C8.94018 13.1793 8.94018 11.2772 10.115 10.104C11.2898 8.93082 13.1946 8.93082 14.3694 10.104C14.8163 10.5503 15.1284 11.4767 15.3436 12.4534C15.6654 13.9139 15.8263 14.6442 15.2439 15.2258C14.6615 15.8074 13.9302 15.6467 12.4676 15.3254C11.4896 15.1105 10.5619 14.7988 10.115 14.3525Z" fill="#1C274C"/>
                    ...
                    <path d="M4.42077 5.4763C4.74602 5.09877 5.09899 4.7458 5.47653 4.42057C5.49505 4.43584 5.51301 4.45214 5.53033 4.46946L7.03033 5.96946C7.32322 6.26235 7.32322 6.73722 7.03033 7.03012C6.73744 7.32301 6.26256 7.32301 5.96967 7.03012L4.46967 5.53012C4.45234 5.51279 4.43604 5.49483 4.42077 5.4763Z" fill="#1C274C"/>
                    <path d="M2.02769 12.7498C2.00934 12.5023 2 12.2522 2 12C2 11.7476 2.00935 11.4975 2.02772 11.2498H4C4.41421 11.2498 4.75 11.5856 4.75 11.9998C4.75 12.414 4.41421 12.7498 4 12.7498H2.02769Z" fill="#1C274C"/>
                    ...
                    <path d="M19.5794 18.5235C19.2542 18.901 18.9012 19.254 18.5237 19.5792C18.5051 19.5639 18.4871 19.5475 18.4697 19.5301L16.9697 18.0301C16.6768 17.7372 16.6768 17.2623 16.9697 16.9695C17.2626 16.6766 17.7374 16.6766 18.0303 16.9695L19.5303 18.4695C19.5477 18.4869 19.5641 18.5049 19.5794 18.5235Z" fill="#1C274C"/>
                    <path d="M21.9723 11.2498C21.9907 11.4975 22 11.7476 22 12C22 12.2522 21.9907 12.5023 21.9723 12.7498H19.9998C19.5856 12.7498 19.2498 12.414 19.2498 11.9998C19.2498 11.5856 19.5856 11.2498 19.9998 11.2498H21.9723Z" fill="#1C274C"/>
                    <path d="M18.5235 4.42057C18.901 4.7458 19.254 5.09877 19.5792 5.4763C19.564 5.49483 19.5477 5.51279 19.5303 5.53012L18.0303 7.03012C17.7374 7.32301 17.2626 7.32301 16.9697 7.03012C16.6768 6.73722 16.6768 6.26235 16.9697 5.96946L18.4697 4.46946C18.487 4.45214 18.5049 4.43584 18.5235 4.42057Z" fill="#1C274C"/>
                    <path d="M12.75 2.0277V4C12.75 4.41421 12.4142 4.75 12 4.75C11.5858 4.75 11.25 4.41421 11.25 4V2.0277C11.4976 2.00934 11.7477 2 12 2C12.2523 2 12.5024 2.00934 12.75 2.0277Z" fill="#1C274C"/>
                    </svg>
            ...
            <li><a href="{{ route('inventory.index') }}" class="ai-icon" aria-expanded="false">
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18 8C18 11.3137 15.3137 14 12 14C8.68629 14 6 11.3137 6 8C6 4.68629 8.68629 2 12 2C15.3137 2 18 4.68629 18 8Z" fill="#1C274C"/>
                    <path opacity="0.7" d="M13.5798 13.7899C13.0765 13.9269 12.5468 14 12 14C9.46679 14 7.30024 12.4302 6.42018 10.2102C3.87293 10.9036 2 13.2331 2 16C2 19.3138 4.68629 22 8 22C11.3137 22 14 19.3138 14 16C14 15.2195 13.851 14.4739 13.5798 13.7899Z" fill="#1C274C"/>
                    <path opacity="0.4" d="M13.5798 13.7896C13.851 14.4736 14 15.2193 14 15.9998C14 17.7768 13.2275 19.3734 12 20.472C13.0615 21.4221 14.4633 21.9998 16 21.9998C19.3137 21.9998 22 19.3135 22 15.9998C22 13.2329 20.1271 10.9034 17.5798 10.21C16.8897 11.9508 15.4085 13.2918 13.5798 13.7896Z" fill="#1C274C"/>
                    </svg>
        ...
        <div class="copyright">
            <p><strong>Landing Page Software</strong> © 2024 All Rights Reserved</p>
            <p>Made with <span class="heart"></span> by <a href="https://synexdigital.com" target="_blank">Synex Digital</a></p>
        </div>
    </div>
</div>
<!--**********************************
