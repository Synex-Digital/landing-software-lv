        ...
        ***********************************-->
		<div class="nav-header">
			<a href="{{ route('welcome') }}" class="brand-logo">
                @if($setting->web_fav)
				<img class="logo-abbr" src="{{ asset('uploads/web/'.$setting->web_fav) }}" alt="">
                @endif
                @if($setting->web_logo)
				<img class="logo-compact" src="{{ asset('uploads/web/'.$setting->web_logo) }}" alt="">
				<img class="brand-title" src="{{ asset('uploads/web/'.$setting->web_logo) }}" alt="">
                @endif
			</a>
											...
											<div class="ms-auto">
												<a href="javascript:void(0)"
													class="btn btn-primary btn-xs sharp me-1"><i
														class="fa fa-pencil"></i></a>
												<a href="javascript:void(0)"
													class="btn btn-outline-danger btn-xs sharp">
													<svg width="14px" height="14px" viewBox="0 0 32 32"
														xmlns="http://www.w3.org/2000/svg">
						...
						<ul class="navbar-nav header-right">
							{{-- <li class="nav-item dropdown notification_dropdown">
								<a class="nav-link  ai-icon" href="javascript:void(0)" role="button"
									...
									<svg width="25px" height="25px" viewBox="0 0 24 24" fill="none"
										xmlns="http://www.w3.org/2000/svg">
										<path d="M12 6.43994V9.76994" stroke="#333333" stroke-width="1.5"
							...
							<li class="nav-item dropdown notification_dropdown">
								<a class="nav-link bell bell-link" href="javascript:void(0)">
									<svg width="25px" height="25px" viewBox="0 0 24 24" fill="none"
										xmlns="http://www.w3.org/2000/svg">
										<path
											d="M18 14H18.8C19.2203 14 19.6364 13.9173 20.0246 13.7565C20.4128 13.5957 20.7656 13.3599 21.0627 13.0627C21.3599 12.7656 21.5957 12.4129 21.7565 12.0247C21.9173 11.6364 22 11.2203 22 10.8V5.20007C22 4.77984 21.9173 4.36371 21.7565 3.97546C21.5957 3.58722 21.3599 3.2344 21.0627 2.93726C20.7656 2.64011 20.4128 2.40447 20.0246 2.24365C19.6364 2.08284 19.2203 2 18.8 2H9.20001C8.77978 2 8.36371 2.08284 7.97546 2.24365C7.58722 2.40447 7.23446 2.64011 6.93732 2.93726C6.64017 3.2344 6.40441 3.58722 6.24359 3.97546C6.08278 4.36371 6 4.77984 6 5.20007V7.6001"
											stroke="#333333" stroke-width="1.5" stroke-linecap="round"
											stroke-linejoin="round" />
										<path
											d="M6.80005 19.6001L8.63 21.4401C9.00092 21.7888 9.49088 21.9829 10 21.9829C10.5091 21.9829 10.9991 21.7888 11.3701 21.4401L13.2 19.6001H14.8C15.6487 19.6001 16.4626 19.263 17.0627 18.6628C17.6629 18.0627 18 17.2487 18 16.4V10.8C18 9.95136 17.6629 9.13747 17.0627 8.53735C16.4626 7.93724 15.6487 7.6001 14.8 7.6001H5.20001C4.35132 7.6001 3.53743 7.93724 2.93732 8.53735C2.3372 9.13747 2 9.95136 2 10.8V16.4C2 17.2487 2.3372 18.0627 2.93732 18.6628C3.53743 19.263 4.35132 19.6001 5.20001 19.6001H6.80005Z"
											stroke="#333333" stroke-width="1.5" stroke-linecap="round"
											stroke-linejoin="round" />
									</svg>
									<span class="badge light text-white bg-primary">3</span>
							...
							<li class="nav-item dropdown header-profile">
								<a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <img width="20"src="{{ asset('uploads/profile/'.auth()->user()->profile) }}" alt="">
                                     @else
								...
								<div class="dropdown-menu dropdown-menu-end shadow">
									<div>
										<div class="p-4 d-flex justify-content-center">
                                            @if(auth()->user()->profile)
                                            <img class="nav-profile " src="{{ asset('uploads/profile/'.auth()->user()->profile) }}" alt="">
                                             @else
									...
									<a href="email-inbox.html" class="dropdown-item ai-icon">
										...
										<span class="ms-2">Role Managment</span>
									</a>
